        ...
        methods: {
            ...
            updateCity() {
                ...
                for (var key in this.arr) {
                    var obj = this.arr[key]
                    if (obj.name === this.resume.address.prov) {
                        this.cityArr = obj.sub
                        break
                    }
                }
                this.resume.address.city = this.cityArr[1].name
            },
            updateDistrict() {
                console.log('市区更新')
                for (var key in this.cityArr) {
                    var obj = this.cityArr[key]
                    if (obj.name === this.resume.address.city) {
                        this.districtArr = obj.sub
                        break
                    }
                }
                if (this.districtArr && this.districtArr.length > 0 && this.districtArr[1].name) {
                    this.resume.address.district = this.districtArr[1].name
                } else {
                    this.resume.address.district = ''
                }
            },
            addSkill() {
